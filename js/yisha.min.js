            ...
            return typeof t == "string" ? n.fn.ysComboBox.methods[t](this, i) : (u = n(this),
                ...
                !f) ? !1 : (r = n.extend({
                    ...
                    e = {
                        ...
                        render: function (t) {
                            var r, o, e, s, i, h;
                            t.data && t.data.length >= 0 && (r = f + "_select",
                                o = "",
                                t.multiple && (o = 'multiple=""'),
                                e = "<select id='" + r + "' name='" + r + "' class='" + ys.toString(t.class) + " select2' " + o + " maxheight=" + t.maxHeight + ">",
                                s = n("#" + r).length > 0,
                                s && n("#" + r).empty(),
                                i = "",
                                h = !1,
                                t.data.length > 0 && (h = t.data[0][t.value] instanceof Array),
                                h || (t.class ? t.multiple || (i += "<option value='' selected='selected'>請選擇<\/option>") : i += "<option value='-1'>全部<\/option>"),
                                n.each(t.data, function (r) {
                                    var u = t.data[r];
                                    typeof u == "string" ? i += "<option value='" + u + "'>" + u + "<\/option>" : u[t.value] instanceof Array ? (i += "<optgroup label='--" + u[t.key] + "--'>",
                                        n.each(u[t.value], function (n) {
                                            var r = u[t.value][n];
                                            i += "<option value='" + r[t.key] + "'>" + r[t.value] + "<\/option>";
                                            u.IsDefault == 1 && (t.default = u[t.key])
                                        })) : (i += "<option value='" + u[t.key] + "'>" + u[t.value] + "<\/option>",
                                            u.IsDefault == 1 && (t.default = u[t.key]))
                                }),
                                s ? n("#" + r).append(i) : (e += i,
                                    e += "<\/select>",
                                    u.append(e),
                                    t.onChange && n("#" + r).change(t.onChange)),
                                n("#" + r).select2(),
                                t.class || n("#" + f).find(".select2-container").width(280),
